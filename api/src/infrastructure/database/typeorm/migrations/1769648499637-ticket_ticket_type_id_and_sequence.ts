...
export class TicketTicketTypeIdAndSequence1769648499637 implements MigrationInterface {
    name = 'TicketTicketTypeIdAndSequence1769648499637'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket_type" ADD "sequence" smallint`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket_type" DROP COLUMN "sequence"`);
